...
function PromotionProductCard({
  ...
  return (
    ...
    >
      ...
      <div
        class={`flex flex-col lg:flex-row w-full gap-4 max-w-[592px] h-full`}
      >
        <figure class="min-w-[295px] h-full" // style={{ aspectRatio }}
        >
          {/* Wishlist button */}
          <div class={clx()}>
            {
        ...
        <div class="flex flex-col justify-between w-full">
          <div class="flex flex-col">
            <h2
              class="line-clamp-3 text-base font-semibold text-blackPrimary mb-4"
