    ...
    <div id={id} class="bg-graySecondary w-full">
      <div class="flex flex-col-reverse md:flex-row items-center justify-between md:gap-5 w-full max-w-7xl m-auto">
            ...
            <ul class="flex min-w-full items-center">
              {benefitsItems.map((item, i: number) => (
                <a href={item.link || "#"} class="">
                  <li
                    class={`flex gap-2 h-10 items-center text-xs font-normal md:font-medium md:text-sm text-grayPrimary bg-whitePrimary hover:bg-purplePrimary hover:text-grayTertiary px-2 ${
        ...
        {liveStore && (
          <a
            href={liveStore.text}
            class="bg-greenPrimary text-grayTertiary px-1.5 py-1 hidden md:flex gap-2 items-center"
          >
            <svg
              width="24"
              height="24"
